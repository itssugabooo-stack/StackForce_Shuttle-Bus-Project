...
// @ts-nocheck 
/*
 * This file exports the `GPS` model and its related types.
 *
...
export type GetGPSAggregateType<T extends GPSAggregateArgs> = {
      [P in keyof T & keyof AggregateGPS]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateGPS[P]>
    : Prisma.GetScalarType<T[P], AggregateGPS[P]>
}
...
export type GetGPSGroupByPayload<T extends GPSGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<GPSGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof GPSGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], GPSGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], GPSGroupByOutputType[P]>
      }
    >
  >
...
export type GPSCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<GPSFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GPSDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['GPS'], meta: { name: 'GPS' } }
  /**
   ...
   * })
  **/
  count<T extends GPSCountArgs>(
    args?: Prisma.Subset<T, GPSCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], GPSCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, GPSGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGPSGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
